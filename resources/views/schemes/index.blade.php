...
<div class="max-w-[1440px] mx-auto p-6">
    <div class="flex justify-between items-center mb-4">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Laporan Penggunaan Skema</h1>
        <a href="{{ route('schemes.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded shadow">Add New Scheme</a>
    </div>
    {{-- Filter Section --}}
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                @foreach ($schemes as $scheme)
                    <tr>
                        ...
                        <td class="px-28 py-4 text-lg whitespace-nowrap">{{ $scheme->assessments_count }}</td>
