...
<div class="max-w-6xl mx-auto p-6">
    <h1 class="text-2xl font-bold mb-6 text-gray-800 dark:text-gray-100">Daftar Asesi</h1>
    <div class="mb-4 flex justify-end">
        <input type="text" placeholder="Cari asesi..." class="w-full sm:w-64 px-4 py-2 border border-gray-300 dark:border-gray-700 rounded focus:ring-blue-500 dark:bg-gray-900 dark:text-gray-100" />
    </div>
    <div class="overflow-x-auto bg-white dark:bg-gray-800 rounded shadow">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead class="bg-gray-50 dark:bg-gray-700">
                <tr>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">NPP</th>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Band</th>
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap">NPP001</td>
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap">NPP002</td>
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap">NPP003</td>
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap">NPP004</td>
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap">NPP005</td>
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap">NPP006</td>
