...
<div class="flex justify-between items-center mb-6">
    <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Realisasi Asesmen Internal</h1>
    <div class="flex items-center gap-4">
        <form method="GET" action="{{ route('assessments.index') }}" class="flex items-center gap-4">
        ...
        <a href="{{ route('assessments.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded shadow">
            Tambah Data Asesmen +
        </a>
    </div>
</div>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-300 dark:bg-gray-700">
                    <tr>
                        ...
                        <th rowspan="2" class="px-6 py-3 text-center text-md font-medium dark:text-gray-300 tracking-wider">BoD</th>
                    ...
                    @foreach($assessments as $assessment)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap flex gap-2">
                                ...
                                <form action="{{ route('assessments.destroy', $assessment->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                    @csrf
                                    @method('DELETE')
